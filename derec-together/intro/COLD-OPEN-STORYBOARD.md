...
![The twelve beats of the cold open as animatic frames](animatic/storyboard-frames.png)
...
| **3** | 1.25–1.83s | f30–f44 | The leaf lands flat on her chest. She lifts it by its edges in both mittens and holds it up to look at it. | Same shot. | **f30:** contact. A flash of mild surprise: whiskers flare, lids wide for 4 frames, recovered by f35. **f35–f44:** she lifts the leaf in both paws and inspects it, head tilted 12° (curious). | – | **f30:** Rhodes moves to E/D and the bass re-plucks D2. **The activity sound (A01):** a dry leaf settling on fur. Guitar B4 at f37.5. | The episode's one delightful action. The sound is one small true foley, not a gag. |
...
| **7** | 3.13–3.71s | f75–f89 | Two otter paws, palms up, each offering a plain stone. Gran's paw is silver-grizzled cocoa and comes from frame left, low. The Harbourmaster's paw is cocoa-grey with a waxed-canvas cuff in Ink and one Jade stitch, and comes from frame right, low. The stones touch Tuck's stone from either side, just under her chin. The paws never touch each other. No faces. | Locked. | Utterly still. Her eyes never leave the lens. | – | **f75:** Rhodes moves to **Gm6** (the borrowed iv; B♭ sighs toward A). **Plink** (S01: glass on stone, then a faint vibraphone A5), panned left: Gran's stone touches. **f82:** **Plink**, identical, panned right: the Harbourmaster's stone touches. **f83–f89:** the held breath. No new sound for 7 frames. | Two stones touching, still dull, for 7 frames: *two never glow*. Then the room holds its breath. |
| **8** | 3.75–4.21s | f90–f101 | **All three stones light amber at once**: a Filament core, an Amber body and a Gilt halo, like the gems on the café table in reference 04. The glow lights her chin and cheeks warmly from below. | Locked. | Holds. Does not move. Eyes on the lens. | The glow ramps up over 3 frames, then settles. Nothing pulses. | **f90: home.** The D(add9) home chord, *bloomed* (faded in over 0.15s) rather than struck: Rhodes E3 A3 D4 F♯4 and the pad, whose filter reaches fully open here. The **crotale A6** glints. The bass returns softly on D2. | The threshold. Enough hands, and the whole thing comes back at once, not note by note. Held for 12 frames, the floor for a phone viewer (R3). |
...
**The ground (f54–f119).**
- Above y 594 the pocket-shot plate is painted as the house day sky:
...
| **f30** | 1.250s | 60,000 | Rhodes E/D (G♯3 B3 E4); bass re-plucks D2 | **A01: the leaf settles on her chest** | The leaf lands |
...
| **f90** | 3.750s | 180,000 | **Home: D(add9)** (Rhodes E3 A3 D4 F♯4 + pad), faded in over 0.15s. Pad filter fully open. Bass D2, soft. **Crotale A6.** | – (S03's bloom *is* the theme here) | All three stones light |
...
6. **The bass sits out from f54 to f89 (the hush and the ritual) and returns on f90,** so the home chord lands with its root.
...
- The friends' paws are pre-rendered for every friend on both edges. Choosing an episode's pair is a comp decision, never a render.
...
| The plate behind the ritual | A defocused derivative of that episode's bar-one plate, warmed 300 K, at 60% exposure, with the house day sky painted above y 594. |
...
| | |
|---|---|
| **Source** | The ritual master, f88–f111 (24 frames), cropped to 9:16 around x 960 (a 608 px-wide window of the 1080p master, scaled up to 1080×1920). |
| **What you see** | Three dull stones touching (f88–f89), all three light (f90), the glow holds, and the threads start to rise (f102–f111). Tuck's face is in the upper third of the vertical frame, and the carry-over rides along. |
...
| **Crop** | 9:16 around x 960. The title page is re-set for vertical in the top third, from the same type sizes scaled to 1080 px wide, so it is never a squeezed crop of the horizontal title. The shield moves to top centre above the imprint. |
...
- **The title page is too busy for the picture.** With type in the top 55% and Tuck in the bottom 45%, a busy plate would fight the type. **Protection:** the plate behind the ritual is defocused, at 60% exposure, with the house sky painted above y 594. The sky is never a photograph of a sky.
...
- **The locked-off tableau draft:** the picture-book page, with words in the sky above the picture. It also flagged the crowded last 17 frames, now protected in §9.
